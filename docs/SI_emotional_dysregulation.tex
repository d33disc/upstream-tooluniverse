...
\newcommand{\sectitle}[1]{\section*{#1}\addcontentsline{toc}{section}{#1}}
...
v12 \cite{szklarczyk2023string} via the ToolUniverse wrapper
...
\noindent
All tool calls, arguments, and results are archived and available from the
