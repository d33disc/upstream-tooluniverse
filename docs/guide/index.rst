...
* **Space & Workspace** → :doc:`toolspace` - Configure which tools to load, cache settings, LLM providers, and hooks via space.yaml. Includes ``life-science.yaml``, a ready-made space covering all life science and general tools.
