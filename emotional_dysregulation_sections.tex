...
draws.\cit{1}  If the categories carve nature at its joints, the joints
...
change, and response modulation.\cit{2}  Each stage corresponds to a
...
strategies, which attempt to suppress an emotion already in flight.\cit{2}
...
studies.\cit{3}  Cognitive reappraisal---reinterpreting a situation to alter
...
on every measure.\cit{3}  Individual differences in habitual strategy use
...
biological vulnerability and environmental invalidation.\cit{4}  Children
...
characteristic of borderline personality disorder.\cit{4}  Crucially,
...
Domain Criteria (RDoC) framework.\cit{5}  RDoC organises psychopathology
...
(\texttt{HP:0000741}).\cit{6}  Each descendant maps to distinct neural
...
dysregulation---into its constituent circuit signatures.\cit{7}  They found
...
phases: fear acquisition, fear extinction, and fear regulation.\cit{8}
...
explanation for years: why PTSD patients \emph{can} learn new safety
...
prefrontal disruption in depression is subtype-specific.\cit{9}  Anhedonic
...
alike.\cit{10}  In their framework, affective and cognitive responses to
...
participants.\cit{11}  The same stimulation protocol, applied to
...
PFC during the processing of negative emotional stimuli.\cit{12}  At first
...
subdivisions.\cit{13}  The lateral nucleus receives the densest cortical
...
resilience.\cit{14}  In their model, positive reappraisal---the cognitive
...
in prefrontal--amygdala connectivity is heritable.\cit{15}  The
