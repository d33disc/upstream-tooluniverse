...
with sufficient statistical power to distinguish signal from noise.\cite{polderman2015}
...
dysregulation — has attracted at least 20 GWAS to date.\cite{sollis2023,nagel2018}
...
cohort.\cite{nagel2018,luciano2018}
...
accumulated 11 GWAS.\cite{purves2020}
...
cohorts with different ascertainment biases.\cite{nagel2018}
...
their common-variant architecture.\cite{nagel2018}
...
\gene{CRH}, \gene{FKBP5}, and \gene{OXTR}.\cite{szklarczyk2023}
...
processing.\cite{szklarczyk2023,ashburner2000}
...
early caregiving quality to long-term emotion regulation capacity.\cite{vantieghem2018}
...
``SLC-mediated neurotransmitter transport'' (R-HSA-442660).\cite{gillespie2022}
...
regions that subserve emotion regulation.\cite{hawrylycz2012}
...
candidate-gene studies remain contentious in the post-GWAS era.\cite{silverman2019}
...
glucocorticoid receptor (GR) sensitivity.\cite{gillespie2022}
...
hormonal backdrop against which both operate.\cite{kanehisa2023}

% Expression topography subsection (from second harvest)
\input{section_expression}
...
monoamine and neuroendocrine pathways.\cite{udalov2026}
...
the serotonin receptor \gene{HTR1A}.\cite{udalov2026}
...
Allen Brain Atlas data independently implicate.\cite{uniprot2023,gillespie2022,hawrylycz2012}
...
top-down emotion regulation.\cite{kredlow2021}
...
psychotherapy, neuromodulation, and neuropeptide-based intervention.\cite{daros2019}
...
between biological vulnerability and invalidating environments.\cite{crowell2009}
Four decades later, DBT has generated 84 registered trials on
ClinicalTrials.gov\cite{clinicaltrials2024} and has expanded far beyond its original indication —
...
between session and daily life).\cite{lynch2006}
...
mitochondrial dysfunction) that differ from those in BPD.\cite{goldstein2024}
...
through which DBT operates in this population.\cite{normannott2025}
...
the late 1980s.\cite{linehan1993}
...
though no such compound has yet advanced beyond early-phase trials.\cite{udalov2026}
...
potentially requiring a different pharmacological approach.\cite{kohler2017}
...
skill use produces synergistic effects.\cite{neacsiu2021}
...
therapeutic strategy.\cite{szklarczyk2023}
...
activity during emotional processing.\cite{moshfeghinia2025}
...
and in the context of high versus low endogenous cortisol.\cite{moshfeghinia2025}
...
that current treatments leave unengaged.\cite{udalov2026}
...
enterprise into a precision discipline.\cite{nagel2018}
