...
Predict the likely age of a person based on their first name using the Agify.io API. Uses statist...
"""
...
def Agify_predict_age(
    ...
    *,
    ...
    ----------
    name : str
        First name to analyze. Examples: 'Michael', 'Emma', 'John', 'Maria', 'James'
    country_id : str | Any
