...
def EnsemblPheno_get_by_variant(
    variant_id: str,
    ...
    *,
    ...
    variant_id : str
        Variant rsID. Examples: 'rs429358' (APOE e4), 'rs7903146' (TCF7L2 diabetes), ...
    ...
    _args = {
        k: v
        for k, v in {"species": species, "variant_id": variant_id}.items()
        if v is not None
    }
...
__all__ = ["EnsemblPheno_get_by_variant"]
