...
Get the full prosecution history timeline for a US patent application. Returns every event record...
"""
...
def USPTO_get_patent_transactions(
...
__all__ = ["USPTO_get_patent_transactions"]
